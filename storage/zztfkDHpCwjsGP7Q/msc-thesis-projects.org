...
** *»Compiler«* -- Quantum-Compiler Construction
     ...
     + Computer Science ::
       ...
       - Required background:    Content of FunQ (LTFY.04.012 /Fundamentals of Quantum Computing/)
       - Recommended background: Compiler construction (e.g., LTAT.03.006, /Automaadid, keeled ja translaatorid/)
...
** *»Verify«* -- Verification
     ...
     + Computer Science ::
       ...
       - Required background:    Content of FunQ (LTFY.04.012 /Fundamentals of Quantum Computing/)
       - Recommended background: Basic stabilizer theory (e.g., read § 10.5 in Nielsen-Chuang)
...
** *»SiPSA«* -- Gradients in quantum neural networks
     ...
     The student's contribution will lie in writing code for and assessment of the »Simultaneous Perturbation
     ...
     + Programming ::
       - Either:   Julia ("Julia is the new MATLAB"), preferred;
       - Or:       Python.
...
** *»Finite«* -- Finite non-commutative Fourier transformation
     ...
     *CONFIDENTIAL!*
     ...
     + Programming ::
       ...
       - Either Julia programming language ("Julia is the new MATLAB")
       - Or Python with Qiskit
...
* Eᴠɢᴇɴɪɪ: Mathematics of Quantum Information Processing
...
** *»Concentration«* -- Derivative-computing measures with strong concentration
     ...
     + Math ::
       - Area:           Fourier analysis, functional analysis
